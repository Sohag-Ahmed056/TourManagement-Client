      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            >
              ...
              <button
                className="mt-1 w-full bg-teal-500 px-6 py-3 text-sm font-bold tracking-wide text-foreground uppercase transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
              >
                Sign Up
              </button>
            </div>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" className="text-foreground transition hover:opacity-75"> Accounts Review </a>
            </li>
            ...
            <li>
              <a href="#" className="text-foreground transition hover:opacity-75"> SEO Optimisation </a>
            </li>
          </ul>
        </div>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-foreground transition hover:opacity-75"> Marketing Calendar </a>
            </li>

            <li>
              <a href="#" className="text-foreground transition hover:opacity-75"> SEO Infographics </a>
            </li>
          </ul>
        </div>
